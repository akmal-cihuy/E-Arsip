...
class DatabaseSeeder extends Seeder {
    public function run(): void {
        ...
        Storage::disk('public')->put('files/sample_file.pdf', $dummyContent);
        ...
        for ($i = 1; $i <= 10; $i++) {
            $file = File::create([
                ...
                'file_path' => 'files/sample_file.pdf',
                'file_type' => 'pdf',
                'file_size' => 1024 * rand(150, 4500),
                'file_date' => now()->subDays(rand(1, 90)),
            ...
            ActivityLog::create([
                ...
                'description' => "Menambahkan arsip {$file->name}",
